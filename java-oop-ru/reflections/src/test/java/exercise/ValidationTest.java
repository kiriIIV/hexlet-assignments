...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Map<String, List<String>> expected2 = Map.of("country", List.of("length less than 4"), "street",
        ...
        Map<String, List<String>> expected3 = Map.of("country", List.of("length less than 4"), "street",
                List.of("can not be null"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
